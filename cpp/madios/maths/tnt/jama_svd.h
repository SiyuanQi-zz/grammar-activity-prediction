...
namespace JAMA
{
   ...
   */
	...
	/* The original code is modified so that the output U matrix is full,
	instead of the original economy sized version.
	*/
...
/////////////////////////////////////////////////////
   ...
   const Array1D<Real>& getSingularValues () const
   {
      return s;
   }
